...
existing index, so it can be used by the agentic pipeline or run_bm25_benchmark.

Usage
-----
    python scripts/build_bm25_index.py --config configs/experiments/agentic_gemini_bm25_recursive_4096_7iter.yaml
